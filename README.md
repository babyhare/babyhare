...
contract Babyhare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babyhare";
    string private _symbol = "Babyhare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb40232BcFfe5be355763b76F0177A57d584913DD); // Marketing Address
    address payable public teamWalletAddress = payable(0x05c9175114933dF2D6576A0287f7D89fEF750Ae0); // Team Address
